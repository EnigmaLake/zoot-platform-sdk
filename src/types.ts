export enum EVENTS {
  ...
  EL_OPEN_HIGH_PLAY_MODAL = "EL_OPEN_HIGH_PLAY_MODAL",
  ...
  EL_SET_TOGGLE_WIDGET_EXPANSION = "EL_SET_TOGGLE_WIDGET_EXPANSION",
  EL_GET_TOGGLE_WIDGET_EXPANSION = "EL_GET_TOGGLE_WIDGET_EXPANSION",
  EL_SET_TOGGLE_WIDGET_VISIBILITY = "EL_SET_TOGGLE_WIDGET_VISIBILITY",
